  ...
  return (
    <div className="max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4">
      <div className="lg:top-20 relative lg:col-span-1 col-span-2">
        <h3 className="text-xl font-bold">Fine Interior Rooms</h3>
        <p className="pt-4">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Enim quis
          necessitatibus qui alias fugit magni!
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 col-span-2 gap-2">
        ...
        src="https://images.pexels.com/photos/4119832/pexels-photo-4119832.jpeg?auto=compress&cs=tinysrgb&w=600"
        alt="/"
        />
        <img
          className="object-cover w-full h-full"
